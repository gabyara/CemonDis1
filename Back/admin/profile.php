...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Perfil Administrador - Distribuidor Hermes</title>
    ...
    <?php 
		...
		$Clients_Staff = $Persistencia->ClientStaffID($_SESSION["id"]);
	?>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php 
									...
									{
										$ModifClientStaff->id = $Clients_Staff->id;;
										$ModifClientStaff->name = $_POST['name'];
										$ModifClientStaff->surname = $_POST['surname'];
										$ModifClientStaff->address = $_POST['address'];
										$ModifClientStaff->city = $_POST['city'];
										$ModifClientStaff->state = $_POST['state'];
										$ModifClientStaff->pass = $Clients_Staff->pass;
										$ModifClientStaff->phonenumber = $_POST['phone'];
										
										$Persistencia->ModificarClientStaff($ModifClientStaff);
										if($Persistencia){
											include('../view/confirm-clientstaff.php');
											unset($_POST['profiledit']);
										}else{
											include('../view/error-clientedit.php');
											}
									}elseif(isset($_POST['profileditpass']))
									{
										$ModifClientStaff->id = $Clients_Staff->id;
										$ModifClientStaff->pass = $_POST['password2'];
										
										$Persistencia->ModificarPass($ModifClientStaff);
										if($Persistencia){
											include('../view/confirm-clientstaff.php');
											unset($_POST['profileditpass']);
										}else{
											include('../view/error-clientedit.php');
											}
									}else{
										include('../view/form-perfil-edit.php');
										}
								?>
